...
logfileName = os.path.dirname(os.path.realpath(__file__)) + "/_project_inventory_modification_report.log"
...
def main():
    ...
    reportName = "Project Inventory Modification Report"
    ...
    if "errorMsg" in reportOptions.keys():
        ...
        projectName = reportData["primaryProjectName"]
